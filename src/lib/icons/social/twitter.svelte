  ...
  ><g
    ...
    ><path d="M0,172v-172h172v172z" fill="none" /><g
      ><path
        ...
        fill="transition duration-300 ease-out fill-current hover:text-[#03a9f4]"
      /><path
        ...
        class="transition duration-300 ease-out fill-current text-secondary hover:text-white"
      /></g
    ></g
  ></svg
>
