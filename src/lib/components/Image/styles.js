export const imgWrapper = (props) => {
  return [
    ...
    { classes: "h-[600px]", styles: "", on: props.type == "custom" && props.size == "lg" },
...
export const imgOverlay = (props) => {
  return [
    { classes: "transition ease-out duration-300 overflow-clip", on: true },
    { classes: "scale-75 max-w-[95%]", on: props.type == "custom" },
    { classes: "w-[340px] -translate-y-24 z-50 group-hover:-translate-y-40 translate-x-24 group-hover:translate-x-40", on: props.type == "custom" && props.size == 'lg' },
    ...
    { classes: "absolute inset-0 rotate-[-12deg] transform group-hover:rotate-[-6deg] z-[-1] max-w-[95%]", styles: `background-image: url(${props.src})`, on: props.type == "card" },
...
export const img = (props) => {
  return [
    ...
    { classes: "w-full max-w-[520px]", styles: "", on: props.size == "lg" && props.type == "custom" },
    { classes: "w-[90%] max-w-[320px]", styles: "", on: props.size == "md" && props.type == "custom" },
    { classes: "max-w-[90%] mx-auto md:max-w-lg z-10", styles: "", on: props.type == "card" },
    { classes: "mx-auto md:max-w-lg", styles: "", on: props.type == "overlay" },
  ];
};
